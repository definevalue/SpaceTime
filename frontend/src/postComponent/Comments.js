...
const Comments = (props) => {
    ...
    return (<div>
        <CardHeader
            avatar={
                <Avatar className={classes.smallAvatar} src={`${baseUrl}/users/photo/` + auth.isAuthenticated().user._id} />
            }
            title={<TextField
        ...
        {props.comments.map((item, i) => {
            return <CardHeader
                avatar={
                    <Avatar className={classes.smallAvatar} src={`${baseUrl}/users/photo/` + item.postedBy._id} />
                }
